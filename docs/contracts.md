...
| `orientation` | 0 · 90 · 180 · 270 | Raddrizza | quarto di giro in senso orario, senza perdita: foto di lato o capovolta. Il modello la sceglie tra le quattro miniature che `/prepare` restituisce in `turns` (solo il modello la vede) |
