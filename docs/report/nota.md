...
**Limiti e prossimi passi.** Il controllo di fedeltà ha un limite sui dettagli microscopici: non distingue strutture sotto i tre pixel. Il rilevatore automatico di inclinazione fatica quando nella foto mancano linee di riferimento evidenti, come spigoli dei muri, porte o mobili squadrati. Il campione iniziale di 24 foto andrà ampliato e studiato con più cura, per mostrare in modo più netto come i workflow reagiscono ai vari difetti e come si differenziano gli output. I prossimi passi per far evolvere il prodotto sono due: portare la funzione in piattaforma per un test A/B, misurando l'impatto reale sui contatti generati; sviluppare un workflow di annuncio che non guardi più la singola foto ma l'intera galleria caricata dall'agente, per riordinare le immagini in base agli elementi che generano più interesse negli utenti e selezionare in automatico la foto con cui l'annuncio si apre.
