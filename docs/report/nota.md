...
- **Costo per immagine.** È ciò che incide sull'azienda, perché ogni annuncio ha tra le dieci e le venti foto e la piattaforma ne pubblica migliaia al giorno. Con i costi osservati nel prototipo, per un annuncio da venti foto: D1 (regole) non fa chiamate e costa praticamente zero; D2 (modello esperto) fa due chiamate a Claude Haiku per foto, circa 0,004 dollari l'una, quindi 0,08 dollari per annuncio; D3 (generativo) paga circa quattro secondi di GPU per foto, 0,003 dollari, quindi 0,06 dollari per annuncio. Su diecimila annunci al giorno: nulla per D1, circa 800 dollari al giorno per D2, circa 600 per D3.
