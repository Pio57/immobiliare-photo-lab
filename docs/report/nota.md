...
- *Output efficace.* Lo giudica lo stesso pool, non io: è l'incrocio delle prime due risposte sulla stessa versione e dallo stesso valutatore. La foto è pubblicabile così com'è se ha preso almeno 4 di qualità e nessuna segnalazione di alterazione. Il conteggio è la quota di versioni pubblicabili senza altro ritocco.
